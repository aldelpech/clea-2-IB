<?php
/**
 * Template Name: IB test 2
 */
?>

<?php get_header('test2'); // Loads the header.php template. ?>
...
<main <?php hybrid_attr( 'content' ); ?>>
	...
	foreach ($colors as $color ) {
		foreach ($nuances as $nuance ) {
			?>	
				<div class="ib-test">
					<a href="https://isabellebyloos.bzh/wp-content/uploads/2016/11/header-049-1800x600.jpg" class="img-hyperlink"><img class="alignnone size-full wp-image-1180" src="https://isabellebyloos.bzh/wp-content/uploads/2016/11/header-049-1800x600.jpg" alt="header-049-1800x600" width="1800" height="600"></a>
